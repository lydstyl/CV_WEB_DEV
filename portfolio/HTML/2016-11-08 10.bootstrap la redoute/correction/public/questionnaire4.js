...
var Qr = function(options){
	var $this = prototype = {
		...
		/* Function : 
		 ------------------------------------------------------------------------------------------- */
		salaire: function(){
			$('.tchat').append('<span class="bubble">Quel est le salaire net mensuel de votre conjoint en € ?</span>');
		...
		/* Function : 
		 ------------------------------------------------------------------------------------------- */
		autre: function(){
			$('.tchat').append('<span class="bubble">Précisez le montant des autres revenus mensuels que perçoit votre conjoint ?</span>');
			$('.tchat').append('<span class="bubble bubble--alt"><input type="text" /><button>Valider</button></span>');
			$this.scroll();
			$('button').on('click', function(){
				var parent = $(this).parent();
		...
		/* Function : 
		 ------------------------------------------------------------------------------------------- */
		recap: function(){
			var text  = 'Le revenu de votre conjoint est de : '+$this.data['salaire']+'€';
				text += '<br />Ses autres revenus sont de : '+$this.data['autre']+'€';
